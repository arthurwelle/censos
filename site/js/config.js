...
export const INDICADORES = [
  ...
  { col: 'a5_esgoto_inadeq', tema: 'A', unidade: '%', dir: -1, dec: 1, den: D, anos: TODOS,
    ...
    desc: 'Tudo que não é rede geral nem fossa séptica: fossa rudimentar, vala, rio, lago, mar, outra forma, e não ter banheiro nem sanitário. É o complemento exato do esgotamento adequado, com a mesma tabela de categorias nos seis censos.' },
  ...
  { col: 'a23_esgoto_adeq', tema: 'A', unidade: '%', dir: +1, dec: 1, den: D, anos: TODOS,
    label: 'Esgotamento adequado',
    desc: 'Rede geral ou fossa séptica, nos seis censos. Critério mais frouxo que o saneamento adequado, que também exige água e banheiro. Some com o esgotamento inadequado e dá 100%.' },
  ...
  { col: 'c1_participacao', tema: 'C', unidade: '%', dir: 0, dec: 1, den: P, anos: TODOS,
    ...
    desc: 'Na força de trabalho, ocupados mais desocupados que procuram, sobre a população de 14 anos ou mais. Atenção a 1991: ali ocupado é quem trabalhou em algum momento dos 12 meses anteriores, e não na semana de referência como nos demais censos — o salto de 1980 para 1991 é em boa parte disso.' },
  { col: 'c2_desocupacao', tema: 'C', unidade: '%', dir: -1, dec: 1, den: P, anos: TODOS,
    label: 'Taxa de desocupação',
    desc: 'Desocupados sobre a força de trabalho, não sobre a população. É a definição usual de desemprego. O período de referência muda: 1991 usa os 12 meses anteriores e os demais censos, a semana de referência.' },
  { col: 'c3_ocupacao', tema: 'C', unidade: '%', dir: +1, dec: 1, den: P, anos: TODOS,
    label: 'Nível de ocupação',
    desc: 'Ocupados sobre a população de 14 anos ou mais. Em 1991 o ocupado é quem trabalhou em algum momento dos 12 meses anteriores, o que infla o indicador naquele censo.' },
  ...
  { col: 'a20_rdpc_baixa', tema: 'C', unidade: '%', dir: -1, dec: 1, den: D, anos: [1980, 1991, 2000, 2010, 2022],
    label: 'Abaixo de meio salário mínimo do ano',
    desc: 'Rendimento domiciliar per capita abaixo de meio salário mínimo DO PRÓPRIO CENSO. A linha se move: o mínimo real mais que dobrou entre 1991 e 2022, então o critério ficou mais exigente e o indicador pode subir sem a renda ter caído. Mede distância do piso legal, não pobreza.' },
  { col: 'a20b_pobreza_real', tema: 'C', unidade: '%', dir: -1, dec: 1, den: D, anos: [1980, 1991, 2000, 2010, 2022],
    label: 'Abaixo da linha de meio salário mínimo de 2022',
    desc: 'A mesma conta com a linha PARADA: meio salário mínimo de 2022 (R$ 606) carregado para cada censo pelo INPC. É o par do indicador acima — um mede distância do piso legal, este mede poder de compra.' },
  { col: 'a19d_rdpc_p10', tema: 'C', unidade: '', dir: +1, dec: 0, den: D, prefixo: 'R$ ', anos: [1980, 1991, 2000, 2010, 2022],
    label: 'Rendimento per capita do décimo mais pobre',
    desc: 'A separatriz que deixa 10% dos domicílios abaixo dela, em reais de janeiro de 2026. A mediana descreve o meio e não se move quando o fundo afunda; esta responde quanto ganha quem está embaixo.' },
  { col: 'c15_palma', tema: 'C', unidade: '', dir: -1, dec: 2, den: D, anos: [1980, 1991, 2000, 2010, 2022],
    label: 'Índice de Palma',
    desc: 'Renda apropriada pelos 10% mais ricos dividida pela dos 40% mais pobres. 2 significa que o décimo do topo ganha o dobro dos quatro décimos de baixo somados. Escolhido no lugar do Gini porque é nas duas pontas que a desigualdade brasileira se move. Não agrega: é calculado direto do microdado em cada recorte.' },
  ...
  { col: 'c10a_rend_fem', tema: 'C', unidade: '', dir: +1, dec: 0, den: P, prefixo: 'R$ ', anos: [1980, 1991, 2000, 2010, 2022],
  ...
  { col: 'c10b_rend_masc', tema: 'C', unidade: '', dir: +1, dec: 0, den: P, prefixo: 'R$ ', anos: [1980, 1991, 2000, 2010, 2022],
  ...
  { col: 'c11a_rend_pretos_pardos', tema: 'C', unidade: '', dir: +1, dec: 0, den: P, prefixo: 'R$ ', anos: [1980, 1991, 2000, 2010, 2022],
  ...
  { col: 'c11b_rend_brancos', tema: 'C', unidade: '', dir: +1, dec: 0, den: P, prefixo: 'R$ ', anos: [1980, 1991, 2000, 2010, 2022],
  ...
  { col: 'c13_aposentadoria', tema: 'C', unidade: '%', dir: 0, dec: 1, den: P, anos: HIST,
    label: 'Recebe aposentadoria ou pensão',
    desc: 'Só o previdenciário, que é o conceito que existe de 1970 a 2010. Em 2022 a variável de acesso controlado junta aposentadoria com Bolsa Família, BPC e aluguel numa pergunta só, e não dá para separar — por isso a série para em 2010. Composição, não juízo.' },
  { col: 'c14_beneficio_amplo', tema: 'C', unidade: '%', dir: 0, dec: 1, den: P, anos: C2010,
    label: 'Recebe aposentadoria, pensão ou transferência',
    desc: 'O conceito amplo: além de aposentadoria e pensão, entram Bolsa Família e outros programas sociais, e em 2022 também BPC e aluguel. Em 2010 os dois indicadores existem, e a diferença entre eles é o tamanho da transferência de renda naquele ano.' },
  ...
  { col: 'f2_resp_mulher', tema: 'F', unidade: '%', dir: 0, dec: 1, den: F, anos: TODOS,
  ...
  { col: 'f3_idade_resp', tema: 'F', unidade: ' anos', dir: 0, dec: 1, den: F, anos: TODOS,
